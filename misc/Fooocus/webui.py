        ...
        if len(task.yields) > 0:
            ...
            if flag == 'preview':
                ...
                yield gr.update(visible=True, value=modules.html.make_progress_html(percentage, title)), \
                    ...
                    gr.update(visible=False)
            if flag == 'results':
                # Update the progress_gallery and gallery components with the generated image
                image_path = product  # Assuming 'product' contains the path to the generated image
                image_html = f'<img src="{image_path}" alt="Generated Image" style="max-width: 100%;">'
                yield gr.update(visible=True), \
                    gr.update(visible=True), \
                    gr.update(visible=True, value=image_html), \
                    gr.update(visible=True, value=image_html)
            if flag == 'finish':
